...
#ifndef __WS_SERIALIZE_JSON_SERIALIZER_H__
#define __WS_SERIALIZE_JSON_SERIALIZER_H__

/**
 * Get a new serializer object
 *
 * @return new serializer object or NULL on failure
 */
struct ws_serializer*
ws_serializer_json_serializer_new(void);

#endif //__WS_SERIALIZE_JSON_SERIALIZER_H__
